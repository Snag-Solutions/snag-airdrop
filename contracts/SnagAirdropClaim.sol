...
contract SnagAirdropClaim is Context, Pausable, ReentrancyGuard, ISnagAirdropClaim, EIP712 {
    ...
    ) external whenNotPaused nonReentrant onlyRouter returns (uint256 amountClaimed, uint256 amountStaked) {
